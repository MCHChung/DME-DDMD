...
#wsave(datadir("sims", "fact_comparisons2.jld2"), compare_dict)

# ============== KLDs ===============
# KLDs of our method 
#our_klds_diff = wload(datadir("latent_dim", "diff_latents.jld2"))["klds_diff"]
our_klds_br = wload(datadir("latent_dim", "brownian_latents.jld2"))["klds_br"]
our_klds_ou = wload(datadir("latent_dim", "ou_latents.jld2"))["klds_ou"]
our_klds_np = wload(datadir("latent_dim", "np_latents.jld2"))["klds_np"]
our_klds_neuron1 = wload(datadir("latent_dim", "neuron_latents.jld2"))["klds_neuron1"]
our_klds_neuron2 = wload(datadir("latent_dim", "neuron_latents.jld2"))["klds_neuron2"]
...
pkld_br = make_kld_plot(our_klds_br, klds_pod_br, klds_nnmf_br, ylims=(5e0, 5e2), yticks=exp10.(0.0:0.5:2.5))
pkld_ou = make_kld_plot(our_klds_ou, klds_pod_ou, klds_nnmf_ou, ylims=(1e0,1e3), yticks=exp10.(0:0.5:3))
pkld_np = make_kld_plot(our_klds_np, klds_pod_np, klds_nnmf_np, ylims=(5e-2,1e3))
pkld_n1 = make_kld_plot(our_klds_neuron1, klds_pod_n1, klds_nnmf_n1, ylims=(1e-1,5e5))
pkld_n2 = make_kld_plot(our_klds_neuron2, klds_pod_n2, klds_nnmf_n2, ylims=(1e0,5e5))
