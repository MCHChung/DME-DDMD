...
**NOTE**: This repo is solely for reproducing the results found in "Discovering interpretable low-dimensional dynamics using maximum entropy". For a general use package, see https://github.com/MCHChung/pyedwin
